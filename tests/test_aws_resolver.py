...
"""
    ...
    def test_enumerate_saml_roles(self):
        ...
        assert result[1] == self.roles[1]
        assert result[2] == self.roles[2]
        assert result[3] == self.roles[3]
        assert result[4] == self.roles[4]
    ...
    def test_display_role(self):
        ...
        assert result[0] == self.display_role[0]
        assert result[1] == self.display_role[1]
        assert result[2] == self.display_role[2]
        assert result[3] == self.display_role[3]
        assert result[4] == self.display_role[4]
        assert result[5] == self.display_role[5]
        assert result[6] == self.display_role[6]
